...
const Login = () => {
  ...
  const googleLogin = useGoogleLogin({
    onSuccess: (tokenResponse) => { console.log(tokenResponse),  navigate("/"), toast({title: "Login successfully",})},
  ...
  const handleLogin = async (e) => {
    ...
    setTimeout(() => {
      ...
      toast({
        ...
        description: "Welcome back to JourneyGen!",
      });
      navigate("/");
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center relative z-10 p-4 md:p-8">
        ...
        >
          {/* <div className="text-center mb-8">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-800 mb-1">Journeygen</h1>
            <p className="text-travel text-sm">Explore More. Experience Life.</p>
          </div> */}

          <div className="space-y-8">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }} >
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Log in to view this page</h2>
            </motion.div>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link to="/forgot-password" className="text-xs text-travel hover:underline">
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  className="text-travel border-travel data-[state=checked]:bg-travel data-[state=checked]:border-travel"
                />
                <label
                  htmlFor="rememberMe"
              ...
              <div className="text-center text-sm mt-2 text-gray-600">
                ...
                <Link to="/signup" className="font-medium text-travel hover:underline">
                  Sign up
                </Link>
              </div>
            </form>
